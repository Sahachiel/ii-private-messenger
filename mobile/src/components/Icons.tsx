...
export const HomeIcon: React.FC<IconProps> = ({ size = 24, color = '#111B21', strokeWidth = 2 }) => (
...
export const ContactsIcon: React.FC<IconProps> = ({ size = 24, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const ShieldIcon: React.FC<IconProps> = ({ size = 24, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const SettingsIcon: React.FC<IconProps> = ({ size = 24, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const SearchIcon: React.FC<IconProps> = ({ size = 20, color = '#8696A0', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const MicIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const CameraIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const ImageIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const FileIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const SmileIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const ReplyIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const ForwardIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const TrashIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const CopyIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
    <Path d="M9 9h10v10H9zM5 5h10v4M5 5v10h4" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
  </Svg>
);

export const PlayIcon: React.FC<IconProps> = ({ size = 18, color = '#111B21' }) => (
  <Svg {...base} width={size} height={size}>
    <Path d="M6 4l14 8-14 8z" fill={color} />
  </Svg>
);

export const PauseIcon: React.FC<IconProps> = ({ size = 18, color = '#111B21' }) => (
  <Svg {...base} width={size} height={size}>
    <Path d="M6 4h4v16H6zM14 4h4v16h-4z" fill={color} />
  </Svg>
);

export const PlusIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const QRIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const StoryIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const GroupIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const LocationIcon: React.FC<IconProps> = ({ size = 22, color = '#111B21', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
...
export const ClockIcon: React.FC<IconProps> = ({ size = 18, color = '#8696A0', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
    <Circle cx="12" cy="12" r="9" stroke={color} strokeWidth={strokeWidth} />
...
export const CheckIcon: React.FC<IconProps> = ({ size = 14, color = '#8696A0', strokeWidth = 2 }) => (
  <Svg {...base} width={size} height={size}>
    <Path d="M4 13l5 5L20 6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
  </Svg>
);

export const CheckDoubleIcon: React.FC<IconProps> = ({ size = 14, color = '#8696A0', strokeWidth = 2 }) => (
